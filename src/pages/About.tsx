    ...
    <section className="py-20 bg-secondary">
      <div className="container mx-auto px-0">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center px-4 mb-16">
          ...
          >
            <img src="https://images.pexels.com/photos/1181354/pexels-photo-1181354.jpeg?auto=compress&cs=tinysrgb&w=800" alt="IT professionals monitoring data servers" className="w-full h-full object-cover" loading="lazy" decoding="async" />
          </motion.div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center px-4">
          ...
          >
            <img src="https://images.pexels.com/photos/1181734/pexels-photo-1181734.jpeg?auto=compress&cs=tinysrgb&w=800" alt="Diverse professionals collaborating in a meeting" className="w-full h-full object-cover" loading="lazy" decoding="async" />
          </motion.div>
