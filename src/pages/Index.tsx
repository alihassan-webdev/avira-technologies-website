            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 items-center mb-12">
              {partners.map((partner, index) => (
                <motion.div
                  ...
                  className="p-4 grayscale hover:grayscale-0 transition-all duration-300 flex items-center justify-center bg-card rounded-xl h-36 border border-border shadow-card hover:shadow-lg"
                >
                  <img
                    src={partner.logo}
