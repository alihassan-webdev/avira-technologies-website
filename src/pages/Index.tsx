...
const Index = () => {
  ...
  return (
    <Layout>
      {/* Hero Carousel */}
      <motion.section
        className="relative h-[400px] md:h-[520px] overflow-hidden bg-[#1B3058]"
      >
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="absolute inset-0 flex items-center justify-start pointer-events-none z-10 pt-52 md:pt-64 will-change-[opacity,transform]"
          >
