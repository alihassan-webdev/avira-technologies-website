...
const OfficeSupplies = () => {
  const supplies = [
    ...
    { icon: Printer, label: "Printer & Scanner", image: "https://cdn.builder.io/api/v1/image/assets%2F8aaf11af3d6f46b4a9a594af1977aff4%2F5528d474737542e1afbd73935b2a59cc?format=webp&width=800&height=1200" },
